    ...
    try {
      ...
      if (isLogin) {
        if (!formData.email || !formData.password) {
          toast.error(
            t("login.emailRequired") + " " + t("login.passwordRequired")
          );
          setIsLoading(false);
          return;
        }
        ...
        if (
          ...
          toast.error(
            t("login.stateCityPinAddressRequired") ||
              "State, City, Pin Code, and Address are required"
          );
          setIsLoading(false);
          return;
        }
        ...
        if (!pinCodeRegex.test(formData.pinCode.trim())) {
          toast.error(
            t("login.invalidPinCode") || "Pin Code must be exactly 6 digits"
          );
          setIsLoading(false);
          return;
        }
        ...
        const cleanedSecondaryPhone = formData.secondaryPhone
          ? formData.secondaryPhone.replace(/\D/g, "")
          : null;
        if (
          formData.secondaryPhone &&
          cleanedSecondaryPhone &&
          !phoneRegex.test(cleanedSecondaryPhone)
        ) {
          toast.error(t("login.invalidPhone"));
          setIsLoading(false);
          return;
      ...
      const userRole =
        response.data.user.role?.toLowerCase() || response.data.user.role;
        ...
        {showForgotPassword ? (
          <div className="space-y-4">
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 space-y-3">
              <h3 className="font-semibold text-gray-800" lang={language}>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={async () => {
                    ...
                    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                    const trimmedEmail = forgotPasswordEmail
                      .trim()
                      .toLowerCase();
                    if (!emailRegex.test(trimmedEmail)) {
                      toast.error(
                        t("login.pleaseEnterValidEmail") ||
              ...
              <div className="space-y-2">
                ...
                {formData.confirmPassword &&
                  formData.password !== formData.confirmPassword && (
                    <p className="text-xs text-red-500" lang={language}>
            ...
            {!isLogin && (
              <div className="space-y-3">
                <label
                  ...
                  lang={language}
                >
                  {t("login.locationDetails") || "Location"}{" "}
                  <span className="text-red-500">*</span>
                </label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={
                        t("login.stateAutoDetected") || "Auto-detected"
                      }
                      lang={language}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg bg-gray-50 text-sm cursor-not-allowed"
                      placeholder={
                        t("login.cityAutoDetected") || "Auto-detected"
                      }
                      lang={language}
                    />
                  </div>
            ...
            {!isLogin && formData.role === "worker" && (
              <div className="space-y-2">
                ...
                {workerTypes.length === 0 ? (
                  ...
                  >
                    <option value="">
                      {t("login.selectWorkerType") || "Select Worker Type"}
                    </option>
                    {workerTypes
            ...
            <>
              ...
              >
                {isLogin
                  ...
                  : t("login.haveAccount") + " " + t("login.loginNow")}
              </button>
            </>
          )}
        </div>
