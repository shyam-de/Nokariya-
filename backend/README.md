# Nokariya Backend - Spring Boot

Spring Boot backend for the Nokariya platform.
...
Or use your IDE to run `NokariyaApplication.java`
...
- Entity classes in `com.nokariya.model` package
