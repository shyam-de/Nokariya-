...
import com.kaamkart.service.WorkerService;
...
public class WorkerController {
    ...
    public ResponseEntity<?> updateWorkerProfile(
            Authentication authentication,
            @Valid @RequestBody com.kaamkart.dto.UpdateProfileDto dto) {
        try {
            Long userId = getUserIdFromAuthentication(authentication);
            com.kaamkart.model.User user = workerService.updateWorkerProfile(userId, dto);
